...
export default function Post({ post }) {
  ...
  return (<div className="flex p-3 cursor-pointer border-b border-gray-200">
        ...
        <div className="flex items-center justify-between">
            ...
            {/*dot icon */}
            <DotsHorizontalIcon className="h-10 hoverEffect w-10 hover:bg-sky-500 p-2" />
        </div>
        ...
        <div className="flex justify-between text-gray-500 p-2">
            ...
            <div className="flex items-center">
                ...
                {likes.length > 0 && <span className={`${hasLiked && "text-red-600"} test-sm select-none `}> {likes.length}</span>}
            </div>
